 ...
 * Date: 25/04/2012
 */
public class OWLObjectUnionOfSerializer extends OWLObjectSerializer<OWLObjectUnionOf> {
    ...
    @Override
    protected OWLObjectUnionOf readObject(BinaryOWLInputStream inputStream) throws IOException, BinaryOWLParseException {
        Set<OWLClassExpression> classExpressions = inputStream.readOWLObjects();
        return inputStream.getDataFactory().getOWLObjectUnionOf(classExpressions);
    }
}
