...
public class AddAxiomDataSerializer extends OntologyChangeDataSerializer<AddAxiomData> {
    ...
    @Override
    public AddAxiomData read(BinaryOWLInputStream inputStream) throws IOException, BinaryOWLParseException {
        OWLAxiom axiom = inputStream.readOWLObject();
        return new AddAxiomData(axiom);
    }
