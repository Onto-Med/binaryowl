...
public class OntologyChangeData2OntologyChangeInfoTypeTranslator implements OWLOntologyChangeDataVisitor<OntologyChangeDataType> {
    ...
    public OntologyChangeDataType visit(RemoveAxiomData data) throws RuntimeException {
        return OntologyChangeDataType.REMOVE_AXIOM;
    }

    public OntologyChangeDataType visit(AddOntologyAnnotationData data) throws RuntimeException {
        return OntologyChangeDataType.ADD_ONTOLOGY_ANNOTATION;
    }

    public OntologyChangeDataType visit(RemoveOntologyAnnotationData data) throws RuntimeException {
        return OntologyChangeDataType.REMOVE_ONTOLOGY_ANNOTATION;
    }

    public OntologyChangeDataType visit(SetOntologyIDData data) throws RuntimeException {
        return OntologyChangeDataType.SET_ONTOLOGY_ID;
    }

    public OntologyChangeDataType visit(AddImportData data) throws RuntimeException {
        return OntologyChangeDataType.ADD_IMPORT;
    }

    public OntologyChangeDataType visit(RemoveImportData data) throws RuntimeException {
